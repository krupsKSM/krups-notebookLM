...
const PdfUploadCard = ({ onFileSelected, uploading, uploadProgress, file }: PdfUploadCardProps) => {
  ...
  // Handle file input change (dialog)
  ...
  return (
    <>
      <div className={`cursor-pointer rounded-xl shadow-md p-8 text-center z-10 w-80  mx-auto
      ...
      {/* Uploading Status */}
      {uploading && (
        <div className="mt-6 max-w-xl mx-auto flex items-center gap-4">
          {/* Spinner + Text */}
      ...
      {file && (
        <p
          className="mt-4 text-sm text-gray-700 truncate whitespace-nowrap overflow-hidden max-w-full"
